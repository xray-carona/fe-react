    ...
    render() {
        return (
            <div>
                ...
                <div className="row">
                    {(this.props.covid_diagnosis && !this.props.loading) ?
                        <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h5>Test #420</h5>
                            <p>System Generated Results not to be consumed without the supervision of Registered Physician</p>
                        </div> : null}
                ...
                {/*            <button className="btn btn-secondary" style={{paddingLeft: '50px',paddingRight: '50px'}}>Next*/}
                {/*                Patient*/}
                {/*            </button>*/}
                {/*        </div>*/}
                {/*    </div>*/}
